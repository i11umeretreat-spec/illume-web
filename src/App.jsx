...
const QUESTIONS = [
  { block:"ТЕЛО", n:"1 / 12",
    text:"Как ваше тело реагирует на начало дня?",
    opts:[
      {text:"Подъём идёт через усилие. Тело весит больше обычного.",sc:{E:2}},
      {text:"Просыпаюсь в своём ритме. Тело в контакте, никакой срочности.",sc:{B:2}},
      {text:"Тело просыпается где-то отдельно от меня.",sc:{A:2,I:1}},
      {text:"Физически нормально, но тревога приходит ещё до первого кофе.",sc:{W:2}},
    ]},
  { block:"ТЕЛО", n:"2 / 12",
    text:"Где в теле сейчас живёт основное напряжение?",
    opts:[
      {text:"Шея, затылок, плечи. Постоянное сжатие которое уже перестал замечать.",sc:{F:2,P:1}},
      {text:"Живот, диафрагма. Что-то внутри не отпускает.",sc:{W:2}},
      {text:"Нигде. Тело как в анестезии, ощущений почти нет.",sc:{A:2,I:2}},
      {text:"В теле скорее живость чем напряжение. Есть подвижность и контакт.",sc:{B:2}},
    ]},
  { block:"ТЕЛО", n:"3 / 12",
    text:"Физическое движение прямо сейчас это:",
    opts:[
      {text:"То что делаю через волевое усилие, потому что надо.",sc:{E:2}},
      {text:"Единственный способ сбросить накопившееся давление.",sc:{P:2,F:1}},
      {text:"Движение приносит удовольствие. Тело откликается с готовностью.",sc:{B:2}},
      {text:"Что-то от чего постепенно отключился. Не тянет и не отталкивает.",sc:{A:2,I:1}},
    ]},
  { block:"ТЕЛО", n:"4 / 12",
    text:"Ваши отношения с собственным телом прямо сейчас:",
    opts:[
      {text:"Хороший контакт. Слышу его сигналы, умею на них реагировать.",sc:{B:2}},
      {text:"Тело сигналит, я слышу, но продолжаю игнорировать. Некогда.",sc:{F:2,P:1}},
      {text:"Тяжёлое и медленное. Двигаюсь как через сопротивление.",sc:{E:2,I:1}},
      {text:"Живу в голове. Тело существует как инструмент, не как часть меня.",sc:{A:2}},
    ]},
  { block:"НЕРВНАЯ СИСТЕМА", n:"5 / 12",
    text:"После насыщенного рабочего дня или большого количества контактов:",
    opts:[
      {text:"Голова продолжает крутиться вхолостую. Остановить трудно.",sc:{F:2,P:1}},
      {text:"Просто выключаюсь. Нет сил даже на простые вещи.",sc:{E:2,I:1}},
      {text:"Умею переключиться. Есть ощущение завершённости и усталость без краха.",sc:{B:2}},
      {text:"Долго отхожу от чужих эмоций. Они остаются внутри.",sc:{W:2}},
    ]},
  { block:"НЕРВНАЯ СИСТЕМА", n:"6 / 12",
    text:"Ваша реакция на неожиданные изменения в последнее время:",
    opts:[
      {text:"Вспышка, внутренняя или внешняя. Потом сожаление.",sc:{F:2}},
      {text:"Торможение. Оцепеневаю, адаптируюсь медленнее чем раньше.",sc:{I:2}},
      {text:"Воспринимаю спокойно или с интересом. Это вызов, не угроза.",sc:{B:2}},
      {text:"Мысли начинают накручивать сценарии сами по себе. Остановить трудно.",sc:{W:2}},
    ]},
  { block:"НЕРВНАЯ СИСТЕМА", n:"7 / 12",
    text:"Когда последний раз по-настоящему отдыхали без фонового напряжения?",
    opts:[
      {text:"Отдых всегда с фоновым «надо бы». Даже в отпуске голова работает.",sc:{P:2}},
      {text:"Не помню. Кажется, разучился что это такое.",sc:{I:2,E:1}},
      {text:"Умею отдыхать по-настоящему. Тело и голова восстанавливаются.",sc:{B:2}},
      {text:"Физически отдыхаю, но голова не отключается никогда.",sc:{A:2}},
    ]},
  { block:"НЕРВНАЯ СИСТЕМА", n:"8 / 12",
    text:"В контакте с другими людьми вы сейчас:",
    opts:[
      {text:"Устаю после общения значительно быстрее чем раньше.",sc:{W:2}},
      {text:"Избегаю или сокращаю. Нужна полная изоляция для восстановления.",sc:{E:2,I:1}},
      {text:"Общение чаще наполняет. Умею выбирать сколько и с кем.",sc:{B:2}},
      {text:"Работаю на автопилоте. Говорю нужное, делаю правильное, но что-то уходит.",sc:{P:2}},
    ]},
  { block:"ВНИМАНИЕ", n:"9 / 12",
    text:"Ваши мысли прямо сейчас это:",
    opts:[
      {text:"Много параллельных потоков. Переключаюсь быстро и неуправляемо.",sc:{F:2,A:1}},
      {text:"Одна тяжёлая вещь которую ношу в фоне постоянно.",sc:{E:2}},
      {text:"Туман или пустота. Думать тяжело, мысли не держатся.",sc:{I:2}},
      {text:"Мысли ясные, фокус хороший. Есть ощущение внутреннего порядка.",sc:{B:2}},
    ]},
  { block:"ВНИМАНИЕ", n:"10 / 12",
    text:"Доступ к новым идеям и творческому мышлению прямо сейчас:",
    opts:[
      {text:"Есть доступ и желание воплощать. Идеи становятся делами.",sc:{B:2}},
      {text:"Идеи есть, но заземлить или довести до конца не получается.",sc:{F:2,A:1}},
      {text:"Всё кажется уже виденным или не стоящим усилий.",sc:{I:2,T:1}},
      {text:"Стена. Нет доступа и нет желания пробовать.",sc:{E:2}},
    ]},
  { block:"ВЕКТОР", n:"11 / 12",
    text:"Принятие решений, важных и бытовых, сейчас:",
    opts:[
      {text:"Принимаю легко и доверяю себе. Редко сомневаюсь после.",sc:{B:2}},
      {text:"Откладываю. Любое решение ощущается как дополнительный груз.",sc:{W:2,E:1}},
      {text:"Решаю быстро и рационально, но потом сомневаюсь было ли правильно.",sc:{A:2,P:1}},
      {text:"Просто нет сил на это. Хочется чтобы кто-то решил за меня.",sc:{E:2,I:1}},
    ]},
  { block:"ВЕКТОР", n:"12 / 12",
    text:"Что привело вас сюда сегодня?",
    opts:[
      {text:"Не могу продолжать в этом темпе. Нужна реальная остановка.",sc:{E:2,P:1}},
      {text:"Что-то завершилось и непонятно что дальше. Нужна точка опоры.",sc:{T:2}},
      {text:"Хочу глубже. Больше ясности, присутствия, понимания себя.",sc:{B:2,T:1}},
      {text:"Чувствую что оторвался от себя. Не знаю когда это произошло.",sc:{A:2,I:1}},
    ]},
];
...
const STATES = {
  B:{color:"#3DBFA8",sec:"#7FE0CC",code:"Хорошая скорость",
     name:"Вы в ресурсе",sub:"Всё работает. Это хорошее начало.",
     body:"Тело работает, голова чистая, граница между своим и чужим держится. Это редкость, и без иронии. Сейчас самое интересное время не чинить что-то, а посмотреть что вообще открывается когда система в порядке. Это другой разговор и другая глубина.",
     bali:"Флагманский Протокол Illume. 7-10 дней полного цикла.",
     remote:"Сенсорный Вакуум. Посмотреть что происходит в абсолютной тишине.",
     service:"massage",style:"full",
     mods:["banya","havan","melukat"],synergy:"Архитектура Возрождения: Полный сброс",
     track:{name:"Сенсорный Вакуум",bundle:false}},
  E:{color:"#C07A28",sec:"#D4581C",code:"Пустой бак",
     name:"Тело на аварийном режиме",sub:"Батарейка мигает уже давно.",
     body:"Тело давно переключилось в режим «сделать самое необходимое и выключиться». Отдых пока не помогает не потому что вы неправильно отдыхаете. А потому что зашли глубже чем один выходной достаёт. Здесь нужен не ещё один отпуск, а другой подход к восстановлению.",
     bali:"Аутентичная баня + Мелукат + Кам Ти Чоу.",
     remote:"Нейро Кокон Гравитация. Очень медленно, без усилий.",
     service:"banya",style:"compressed",
     mods:["banya","melukat"],synergy:"Мягкое восстановление",
     track:{name:"Нейро Кокон: Гравитация",bundle:false}},
  W:{color:"#2D7FFF",sec:"#6BB8FF",code:"Губка",
     name:"Всё чужое остаётся внутри",sub:"Граница между своим и чужим стала очень тонкой.",
     body:"Вы тот человек которому звонят когда плохо. И вы берёте трубку. Каждый раз. Чужое настроение прилипает, уходите домой, носите ночью, разбираете утром. Это не слабость и не сверхчувствительность. Это особенность системы которую просто никто не объяснял как обслуживать.",
     bali:"Аудиококон Глубокая Вода + Мелукат.",
     remote:"Глубокая Вода. Чтобы наконец побыть только собой.",
     service:"online",style:"wavy",
     mods:["melukat","breath"],synergy:"Очищение поля",
     track:{name:"Глубокая Вода",bundle:false}},
  F:{color:"#FF6B4A",sec:"#FF9060",code:"Разгон без тормозов",
     name:"Энергия есть. Приземлиться негде.",sub:"Много всего, ничего не завершается.",
     body:"Энергии вроде достаточно. Только она нигде не задерживается: переключаетесь, начинаете, не заканчиваете, снова начинаете. Тело тем временем держит всё что не выразилось. В плечах, в челюсти, в том постоянном лёгком напряжении которое стало фоном. Нужна не остановка. Нужна точка приземления.",
     bali:"Холодовая терапия + Хаван + Баня.",
     remote:"Катализатор. Чтобы вся эта энергия нашла выход.",
     service:"banya",style:"energetic",
     mods:["banya","havan"],synergy:"День Огня: Тотальное очищение",
     track:{name:"Катализатор",bundle:false}},
  A:{color:"#3DBFA8",sec:"#7FE0CC",code:"Голова без тела",
     name:"Живёте немного выше себя",sub:"Справляетесь отлично. Тело стало транспортом для головы.",
     body:"Голова работает хорошо, это заметно. Задачи закрываются, разговоры происходят, всё нормально. Только где-то по дороге тело стало просто средством передвижения для головы. Иногда смотрите на свою жизнь немного со стороны. Как будто читаете про неё, а не живёте в ней.",
     bali:"Кам Ти Чоу + Аутентичная баня. Вернуть голову в тело.",
     remote:"Сенсорный Вакуум. Остановить поток мыслей через абсолютную тишину.",
     service:"massage",style:"crystalline",
     mods:["banya","dance"],synergy:"Возврат в тело",
     track:{name:"Сенсорный Вакуум",bundle:false}},
  I:{color:"#A8C4D0",sec:"#C8E0EC",code:"Стоп-кран",
     name:"Система остановилась сама",sub:"Это не лень. Тело приняло решение за вас.",
     body:"Не усталость и не лень, хотя со стороны может выглядеть именно так. Просто в какой-то момент система исчерпала все способы справляться и остановилась. Всё стало примерно одинаковым. Ничего особо не хочется. Здесь нужно очень аккуратно и без давления. Никакого «возьми себя в руки».",
     bali:"Тёплая баня + Хаван + индивидуальная сессия с Нади.",
     remote:"Нейро Кокон Гравитация. Без требований, очень медленно.",
     service:"banya",style:"still",
     mods:["banya"],synergy:"Без давления",
     track:{name:"Нейро Кокон: Гравитация",bundle:false}},
  P:{color:"#9B68F0",sec:"#7B4FE8",code:"Турбо-режим",
     name:"Хорошо работает. До поры до времени.",sub:"Внешне всё нормально. Внутри топливо заканчивается.",
     body:"Темп стал нормой настолько, что вы уже не особо помните как было иначе. Остановка пугает больше чем продолжение. Усталость приходит, но не накапливается в «стоп», а в следующую задачу. Система работает. Вопрос в том на каком топливе и до каких пор.",
     bali:"Хаван + 3-дневный протокол декомпрессии.",
     remote:"Катализатор, потом Сенсорный Вакуум. Сначала сбросить, потом остановиться.",
     service:"online",style:"tight",
     mods:["havan","breath"],synergy:"Сброс топлива",
     track:{name:"Катализатор + Сенсорный Вакуум",bundle:true}},
  T:{color:"#E0C040",sec:"#F0D860",code:"Развилка",
     name:"Что-то кончилось. Что начнётся, пока непонятно.",sub:"Между одним и другим. Дискомфортно, но не опасно.",
     body:"Старые маршруты не работают, привычные ответы не подходят. Это немного некомфортно. Но это ровно то окно в котором можно войти в совершенно другой ритм жизни, если не торопиться захлопнуть его следующей задачей. Редкий момент когда система открыта и пластична.",
     bali:"Священная топография + Мелукат + интеграционная сессия.",
     remote:"Глубокая Вода, потом Нейро Кокон. Пройти через переход, а не убежать от него.",
     service:"melukat",style:"transition",
     mods:["topo","melukat"],synergy:"Сакральная Экспедиция: Элемент Воды",
     track:{name:"Глубокая Вода + Нейро Кокон",bundle:true}},
};
            ...
            {phase==="idle"&&(
              <div>
                <p style={{
                  ...
                  12 вопросов о теле, нервной системе и внимании. Результат — конкретное состояние и следующий шаг.
                </p>
                <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:32}}>
                  {["Тело","Нервная система","Внимание","Вектор"].map(tag=>(
                    <span key={tag} style={{
                      border:`1px solid ${C.p}22`,borderRadius:100,
              ...
              <div style={{animation:"rFade 0.4s ease"}}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <a href={constructorLink(resultSt)} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      Нейро-Кокон: {resultSt.track.name}
                    </div>
                    <div style={{
                      fontSize:11,color:C.dim,lineHeight:1.55,marginBottom:12,flexGrow:1,
                      fontFamily:"'Inter',sans-serif",
